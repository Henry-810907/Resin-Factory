 ...
 * 浮动 WhatsApp 联系按钮:
 *  - 固定在右下角(所有页面)
 *  - WhatsApp 官方绿色 + 官方 logo
 *  - 点击直接打开 WhatsApp 聊天(wa.me 链接,自动适配 web/桌面/手机 app)
 *  - hover 显示号码气泡
 */
export default function WhatsAppFloat() {
  // wa.me 要求"国家码 + 号码",不带 + 和空格;+86 136 8269 2148 → 8613682692148
  const PHONE = "8613682692148";
  const DISPLAY = "+86 136 8269 2148";
  const PREFILL =
    "Hi Resin Factory, I'd like to get a quote for custom resin figurines.";
