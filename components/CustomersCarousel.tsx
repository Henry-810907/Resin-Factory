        ...
        {customers.map((it, i) => (
          <div key={i} data-card className={cardCls}>
            <div className="relative w-full aspect-square">
              <Image src={IMAGES[i] ?? IMAGES[0]} alt={`Customer work — ${it.name}`} fill sizes="(max-width: 768px) 300px, 450px" quality={65} loading="lazy" className="object-cover object-center" />
            </div>
