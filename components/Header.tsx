...
const PHONE_NUMBER = "+86 136 8269 2148";
const PHONE_TEL = "tel:" + "+861" + "368269" + "2148";
const WHATSAPP_HREF = "https://wa.me/" + "861" + "368269" + "2148";
const EMAIL = "henry@resin-factory.com";
const EMAIL_HREF = "mailto:henry@resin-factory.com";
    ...
    <header className="w-full sticky top-0 z-50">
      ...
      <div className="bg-brand-dark text-slate-300 text-xs py-1.5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-center gap-4 sm:gap-6 flex-wrap">
          <a href={EMAIL_HREF} onClick={() => { if (typeof window !== 'undefined' && typeof (window as any).gtag === 'function') { (window as any).gtag('event', 'conversion', { 'send_to': 'AW-18376214280/_2MFCNvGht4cEliOu7pE' }); } }} className="hover:text-brand-orange transition flex items-center gap-1.5 underline">
          ...
          <a href={WHATSAPP_HREF} target="_blank" rel="noopener noreferrer" className="hover:text-brand-orange transition flex items-center gap-1.5 underline">
          ...
          <a href={PHONE_TEL} className="hover:text-brand-orange transition flex items-center gap-1.5 underline">
