      ...
      <div className="relative z-10 w-full h-full pl-4 sm:pl-6 md:pl-16 lg:pl-24 pr-4 sm:pr-6 flex items-center">
        <div className="bg-brand-dark/85 backdrop-blur-sm rounded-lg px-5 sm:px-8 md:px-12 py-7 sm:py-10 md:py-16 shadow-2xl text-white max-w-xl">
          <div key={index} className="hero-fade">
            <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold leading-tight mb-3 sm:mb-5 tracking-tight">{dict.h1}</h1>
          ...
          <a
            href="https://wa.me/8613682692148"
            target="_blank"
            rel="noopener noreferrer"
            className="mt-4 inline-flex items-center gap-2 text-sm text-slate-200 hover:text-white transition"
          >
            ...
            <span>Chat on WhatsApp: +86 136 8269 2148</span>
          </a>
        </div>
      </div>
