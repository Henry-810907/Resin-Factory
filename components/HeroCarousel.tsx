      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        >
          ...
          <div className="relative w-full h-full shrink-0">
            <Image src={IMAGES[slideCount - 1]} alt={dict.slides[slideCount - 1].alt} fill sizes="100vw" quality={65} className="object-cover object-center" />
          </div>
          {/* 真实 slides */}
          {dict.slides.map((s, i) => (
          ...
          {/* 克隆头（第一张的副本） */}
          <div className="relative w-full h-full shrink-0">
            <Image src={IMAGES[0]} alt={dict.slides[0].alt} fill sizes="100vw" quality={65} className="object-cover object-center" />
          </div>
        </div>
      </div>
