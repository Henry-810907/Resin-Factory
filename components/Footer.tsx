...
export default function Footer({ dict, navDict, lang }: Props) {
  ...
  return (
    <footer className="bg-brand-dark text-slate-300">
      ...
      <div className="bg-slate-950 py-3 px-5 sm:px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <p className="text-slate-500 text-xs">
            © {new Date().getFullYear()} Shenzhen Heli Toys Co., Ltd. {dict.rights}
          </p>
          <a href="https://www.linkedin.com/in/resin-factory-founder" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
